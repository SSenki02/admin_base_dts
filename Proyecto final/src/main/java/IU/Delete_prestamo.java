 ...
 * @author shans
 */
public class Delete_prestamo extends javax.swing.JFrame {

    /**
     * Creates new form Delete_usuario
     */
    public Delete_prestamo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("¿Esta seguro de eliminar este prestamo del registro?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String consulta = "DELETE FROM DJS_PRESTAMO WHERE ID_PREST=?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Delete_prestamo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Delete_prestamo().setVisible(true);
            }
        });
    }
