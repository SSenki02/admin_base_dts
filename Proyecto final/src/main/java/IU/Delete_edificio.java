 ...
 * @author shans
 */
public class Delete_edificio extends javax.swing.JFrame {

    /**
     * Creates new form Delete_edificio
     */
    public Delete_edificio() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eliminar edificio");
        ...
        jLabel2.setText("¿Esta seguro de eliminar este edificio del registro?");
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(buscador, javax.swing.GroupLayout.PREFERRED_SIZE, 363, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String consulta = "DELETE FROM DJS_EDIFICIO WHERE ID_EDIF=?";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            model.setRowCount(0);
            intUs.listar(buscador.getText()).forEach((u) -> model.addRow(new Object[]{u.getNombre(),u.getDireccion(), u.getTelefono(), u.getEmail(), u.getId_edif()}));
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Delete_edificio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Delete_edificio().setVisible(true);
            }
        });
    }
